 ...
 * zurückgesetzt: Die Gruppen werden zur Schule zurückgerufen und gehen
 * zum Abschluss mit Punkten und Abzeichen.
 */
    ...
    <Dialog open>
      <DialogContent className="max-w-sm">
        ...
        <p className="text-center font-serif text-sm italic leading-relaxed text-foreground/75">
          Die Zeit ist um. Weiter ermitteln können wir jetzt nicht mehr.
        </p>
        <Link
          to="/abschluss"
