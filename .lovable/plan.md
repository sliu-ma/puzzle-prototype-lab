...
- Jede Zeitmeldung schliesst sich nach 30 Sekunden automatisch.
...
- Die dringenden Meldungen der letzten 15 Minuten verhalten sich gleich (auch 30 Sekunden), damit die Ermittlung nicht blockiert wird.
...
- Beim Setzen von `popup` einen Timer (30 s) starten, der `setPopup(null)` aufruft; Timer aufräumen, wenn das Pop-up vorher geschlossen wird.
